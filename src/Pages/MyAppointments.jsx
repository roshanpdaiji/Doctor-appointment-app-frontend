...
function MyAppointments() {
  ...
  return (
    ...
    //           {item.isCompleted && (
    //             <button className="sm:min-w-48 py-2 px-4 border-2 border-gray-500 rounded text-gray-500 bg-gray-100 text-center transition duration-300 ease-in-out text-sm font-semibold">
